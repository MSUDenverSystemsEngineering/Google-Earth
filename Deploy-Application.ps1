...
Try {
	...
	[string]$appName = 'Earth'
	[string]$appVersion = 'Pro 7.3'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-MSI -Action "Install" -Path "$dirFiles\GoogleEarth-7.3.msi" -Parameters "/qn" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-MSI -Action "Uninstall" -Path "{ECF2E224-42F5-4E50-B58E-94CA70E85697}"
